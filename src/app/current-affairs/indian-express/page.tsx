...
export default function IndianExpressCurrentAffairsPage() {
  ...
  const fetchArticles = async () => {
    try {
      setLoading(true);
      const res = await fetch("/api/current-affairs/indian-express?limit=50");
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-2xl">
            Latest news and investigative journalism from <span className="font-semibold text-orange-600">Indian Express</span> - 
            Featuring in-depth analysis and current affairs coverage for UPSC preparation
          </p>
        </div>
        ...
        {loading && (
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-slate-600">Fetching latest articles from Indian Express...</p>
          </div>
        )}
          ...
          <div className="grid gap-6">
            ...
            <div className="bg-white rounded-lg border border-orange-200 p-6 mb-6">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-lg font-semibold text-orange-600">Indian Express</p>
                </div>
              </div>
            </div>
            ...
            {articles.map((article, index) => (
              <article
                ...
                className="bg-white rounded-lg border border-orange-200 hover:border-orange-300 hover:shadow-md transition-all p-6"
              >
