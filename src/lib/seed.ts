...
export const seedExamCourses: ExamCourse[] = [
  { id: "neet-arjuna-2.0-2027", examSlug: "neet", active: true, order: 1, title: "Arjuna NEET 2.0 2027", image: "https://via.placeholder.com/400x300?text=Arjuna+NEET+2.0", badge: "ONLINE", badgeColor: "bg-purple-600", instructor: "Arjun Singh", instructorImage: "", price: 4999, originalPrice: 5500, startDate: "01 Jan 2026", endDate: "30 Jun 2028", duration: "30 months", features: ["Complete Physics, Chemistry & Biology coverage", "500+ hours of video lectures", "Weekly tests and assignments", "Doubt support 24/7", "Personal mentor guidance"], description: "Comprehensive NEET preparation course from basics to advanced level with live interactive sessions.", cta: "ENROLL NOW", link: "/courses/neet-arjuna-2.0-2027" },
  { id: "neet-lakshya-2028", examSlug: "neet", active: true, order: 2, title: "Arjuna NEET 2027 + Lakshya NEET 2028", image: "https://via.placeholder.com/400x300?text=Arjuna+Lakshya", badge: "ONLINE", badgeColor: "bg-green-600", instructor: "Lakshya Academy", instructorImage: "", price: 48000, originalPrice: 62000, startDate: "15 Jan 2026", endDate: "31 Dec 2028", duration: "36 months", features: ["Two-year integrated program", "1000+ hours of live classes", "Monthly full-length mock tests", "Personalized performance tracking", "Expert doubt clearing sessions", "NEET special: Chemistry focus modules"], description: "Two-year program covering complete NEET syllabus with advanced problem-solving techniques.", cta: "ENROLL NOW", link: "/courses/neet-lakshya-2028" },
  { id: "neet-vidyapeeth-11", examSlug: "neet", active: true, order: 3, title: "Vidyapeeth 11 NEET (Target 2028)", image: "https://via.placeholder.com/400x300?text=Vidyapeeth+NEET", badge: "OFFLINE", badgeColor: "bg-red-600", instructor: "Dr. Vikram Sharma", instructorImage: "", price: 5000, originalPrice: 6000, startDate: "01 Apr 2026", endDate: "30 Mar 2028", duration: "24 months", features: ["Class 11 focus for 2-year preparation", "Concept building from scratch", "Daily practice problems", "Bi-weekly assessments", "Group study sessions", "Career counseling included"], description: "Ideal for Class 11 students targeting NEET 2028 with comprehensive foundation building.", cta: "EXPLORE NOW", link: "/courses/vidyapeeth-neet-11" },
  { id: "cet-foundation", examSlug: "cet", active: true, order: 1, title: "CET Foundation Batch 2026", image: "https://via.placeholder.com/400x300?text=CET+Foundation", badge: "ONLINE", badgeColor: "bg-blue-600", instructor: "Prof. Rajesh Kumar", instructorImage: "", price: 3999, originalPrice: 4999, startDate: "01 Feb 2026", endDate: "31 Dec 2026", duration: "11 months", features: ["CET syllabus complete coverage", "300+ practice problems", "Weekly mock tests", "Solution videos for all topics", "Live doubt sessions twice a week"], description: "Complete CET preparation for Engineering entrance with focused curriculum.", cta: "ENROLL NOW", link: "/courses/cet-foundation-2026" },
  { id: "ca-foundation", examSlug: "ca", active: true, order: 1, title: "CA Foundation - Comprehensive Program", image: "https://via.placeholder.com/400x300?text=CA+Foundation", badge: "ONLINE", badgeColor: "bg-emerald-600", instructor: "CA Priya Sharma", instructorImage: "", price: 12000, originalPrice: 15000, startDate: "01 Mar 2026", endDate: "31 Aug 2026", duration: "6 months", features: ["All 4 papers covered", "Weekly live sessions", "Compilation of case studies", "Mock test series", "Professional guidance"], description: "Complete CA Foundation program with expert instructors and comprehensive study material.", cta: "ENROLL NOW", link: "/courses/ca-foundation" }
];
];
